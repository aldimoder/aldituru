...
//=================================================//
const bal= (teks) => {
haikal.sendMessage(m.chat, { text: teks, contextInfo:{"externalAdReply": {"title": `ꪶ🌷ꫂ ALDI MODER ꪶ🌷ꫂ ${ngazap(prefix)}`,"body": `ꪶ🌷ꫂ ALDI MODER ꪶ🌷ꫂ ${ngazap(prefix)}`, "previewType": "PHOTO","thumbnailUrl": ``,"thumbnail": kalimage,"sourceUrl": `https://youtube.com/c/HwModsWa857`}}}, { quoted: doc })
} 
// Target
const reply = (teks) => {
...
const anjay = (teks) => {
 haikal.sendMessage(m.chat, { image: kalimage, caption: teks, contextInfo:{"externalAdReply": {"title": `SC ꪶ🌷ꫂ ALDI MODER ꪶ🌷ꫂ`,"body": `Selamat ${salam} kak ${pushname}`,
previewType: "PHOTO",
showAdAttribution: true,
sourceUrl: `https://youtube.com/c/HwModsWa857`,
thumbnailUrl: 'https://telegra.ph/file/a5e229afeb4dad4f35204.jpg', 
...
haikal.sendMessage(m.chat, anuala, `ꪶ🌷ꫂ ALDI MODER ꪶ🌷ꫂ${ngazap(prefix)}`, m)
}
}
break
case 'bugcrot' :
